defmodule Ecto.Adapters.Redshift do
  @moduledoc """
  Adapter module for Amazon Redshift.
  ...
  As Redshift is based on PostgreSQL 8, there are some limitations with this adapter.

  ### Read after writes

  Because Redshift does not support RETURNING clauses in INSERT and
  ...
  recompilation in order to make an effect.
    ...
    * `:adapter` - The adapter name, in this case, `Ecto.Adapters.Redshift`
